#ifndef _ROS_jsk_footstep_controller_GoPosGoal_h
#define _ROS_jsk_footstep_controller_GoPosGoal_h
...
namespace jsk_footstep_controller
{
  ...
  class GoPosGoal : public ros::Msg
  {
    public:
      ...
      enum { NEW_TARGET = 0 };
      enum { OVER_WRITE = 1 };
      enum { ABSOLUTE_NEW_TARGET = 2 };
      enum { ABSOLUTE_OVER_WRITE = 3 };
    ...
    const char * getType(){ return "jsk_footstep_controller/GoPosGoal"; };
    const char * getMD5(){ return "69d55867d9a94dddd5bc8dc8910558cf"; };
