...
static const char BCAP[] = "bcap_service/bcap";
  ...
  class bcapRequest : public ros::Msg
  {
    ...
    const char * getType(){ return BCAP; };
    const char * getMD5(){ return "e2e62a99900f0dacb6b7c7114cde3983"; };
  ...
  class bcapResponse : public ros::Msg
  {
    ...
    const char * getType(){ return BCAP; };
    const char * getMD5(){ return "71670d22c1b3a79073449b5cc4047e38"; };
