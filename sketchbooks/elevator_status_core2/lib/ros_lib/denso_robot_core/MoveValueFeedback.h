#ifndef _ROS_denso_robot_core_MoveValueFeedback_h
#define _ROS_denso_robot_core_MoveValueFeedback_h
...
namespace denso_robot_core
{
  ...
  class MoveValueFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "denso_robot_core/MoveValueFeedback"; };
