#ifndef _ROS_denso_robot_core_DriveStringFeedback_h
#define _ROS_denso_robot_core_DriveStringFeedback_h
...
namespace denso_robot_core
{
  ...
  class DriveStringFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "denso_robot_core/DriveStringFeedback"; };
    const char * getMD5(){ return "76249fb45cba333e6a82c7f91cfe1879"; };
