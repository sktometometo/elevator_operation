#ifndef _ROS_denso_robot_core_MoveStringResult_h
#define _ROS_denso_robot_core_MoveStringResult_h
...
namespace denso_robot_core
{
  ...
  class MoveStringResult : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "denso_robot_core/MoveStringResult"; };
