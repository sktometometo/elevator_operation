#ifndef _ROS_denso_robot_core_DriveValueResult_h
#define _ROS_denso_robot_core_DriveValueResult_h
...
namespace denso_robot_core
{
  ...
  class DriveValueResult : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "denso_robot_core/DriveValueResult"; };
