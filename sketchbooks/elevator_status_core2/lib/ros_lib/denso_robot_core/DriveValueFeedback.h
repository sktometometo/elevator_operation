#ifndef _ROS_denso_robot_core_DriveValueFeedback_h
#define _ROS_denso_robot_core_DriveValueFeedback_h
...
namespace denso_robot_core
{
  ...
  class DriveValueFeedback : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "denso_robot_core/DriveValueFeedback"; };
